...
export const LIQUID_GRADIENTS = {
  violet: { angle: 135, colors: ['#7C5CFF', '#5B3FD9'] },
  blue:   { angle: 135, colors: ['#00C2FF', '#0A84FF'] },
  green:  { angle: 135, colors: ['#30D158', '#1FA844'] },
  orange: { angle: 135, colors: ['#FFB020', '#FF8A00'] },
  red:    { angle: 135, colors: ['#FF453A', '#D32F27'] },
} as const;
...
export const DS = {
  color: {
    ...
    bgElevated: '#080808',
    bgTertiary: '#101010',
    surface1: '#1C1C1E',  // iOS surface primary (opaco, per liste/righe Settings-style)
    surface2: '#2C2C2E',  // iOS surface secondary
    surface3: '#3A3A3C',  // iOS surface elevated
    ...
    // Testo
    text: '#FFFFFF',
    text2: '#8E8E93',   // iOS secondary label
    text3: '#636366',   // iOS tertiary label
    // Semantici (palette iOS)
    success: '#30D158',
    warning: '#FF9F0A',
    danger: '#FF453A',
    info: '#0A84FF',    // iOS system blue
    ...
    purple: '#BF5AF2',
    // Liquid Glass iOS 27 — palette di marca (selezionabile via preset 'liquidglass')
    lgPrimary: '#7C5CFF',
    lgSecondary: '#00C2FF',
    lgWarning: '#FFB020',
    lgInfo: '#64D2FF',
...
export type ProfileConfigLite = { kind: string; color: string; initials?: string; icon?: string; emoji?: string; vector?: string };
...
// FUNCTION_COLORS — un colore distinto per OGNI funzione (spec Liquid Glass iOS 27).
// Risolve il problema "icone tutte dello stesso colore": ogni voce comunica la propria funzione.
export const FUNCTION_COLORS = {
  // Pianificazione
  generaTurni: '#0A84FF', matrici: '#4A90FF', matriciStagionali: '#32D74B', simulatore: '#FF9F0A', reparti: '#64D2FF',
  // Personale
  personale: '#30D158', ferie: '#FFD60A', richieste: '#FF9F0A', desiderata: '#BF5AF2', importPersonale: '#32D74B', reperibilita: '#64D2FF', accessi: '#BF5AF2',
  // Controllo
  criticita: '#FF453A', direzione: '#FFD60A', bancaOre: '#30D158', postazioni: '#FF9F0A', copertura: '#0A84FF', report: '#FFD60A',
  // Account
  profilo: '#BF5AF2', sicurezza: '#FF453A', notifiche: '#0A84FF', backup: '#32D74B', dispositivi: '#64D2FF', personalizzazione: '#BF5AF2',
} as const;
...
// TYPOGRAPHY
export const TYPE = {
  largeTitle: { fontSize: 34, fontWeight: '700' as const },   // Large Title 34 Bold
  screenTitle: { fontSize: 28, fontWeight: '700' as const },  // Screen Title 28 Bold
  sectionTitle: { fontSize: 22, fontWeight: '600' as const }, // Section Title 22 Semibold
  cardTitle: { fontSize: 18, fontWeight: '600' as const },    // Card Title 18 Semibold
  body: { fontSize: 16, fontWeight: '400' as const },         // Body 16 Regular
  caption: { fontSize: 13, fontWeight: '500' as const },      // Caption 13 Medium
