  ...
  return (
    <>
      ...
      >
        ...
        <Stack.Screen name="personalizzazione" />
        <Stack.Screen name="profilo" options={{ presentation: 'modal' }} />
        <Stack.Screen name="banca-ore" options={{ presentation: 'modal' }} />
        <Stack.Screen name="direzione" options={{ presentation: 'modal' }} />
        <Stack.Screen name="reperibilita" options={{ presentation: 'modal' }} />
        <Stack.Screen name="import-personale" options={{ presentation: 'modal' }} />
        <Stack.Screen name="assistente" options={{ presentation: 'modal' }} />
        <Stack.Screen name="turni" />
        <Stack.Screen name="personale-lista" />
        <Stack.Screen name="copertura" />
        <Stack.Screen name="reparti" />
        <Stack.Screen name="report" />
        <Stack.Screen name="matrice-editor" />
